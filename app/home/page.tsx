...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    let unsubscribeLatest: (() => void) | undefined
    ...
    try {
      ...
      unsubscribePremium = onSnapshot(premiumQuery, 
        (snapshot) => {
      ...
      unsubscribeLatest = onSnapshot(latestQuery,
        (snapshot) => {
          const companies = snapshot.docs.map(doc => ({
            id: doc.id,
            ...doc.data(),
  ...
  const showPlaceholder = !isLoading && premiumCompanies.length === 0 && latestCompanies.length === 0
  ...
  return (
    <div className="min-h-screen">
      ...
      {!isLoading && !error && showPlaceholder ? (
        <section className="py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <>
          {/* Premium Companies */}
          {!isLoading && premiumCompanies.length > 0 && (
            <section className="py-12 md:py-16">
              <div className="max-w-7xl mx-auto px-4">
          ...
          {/* Latest Companies */}
          {!isLoading && latestCompanies.length > 0 && (
            <section className="py-12 md:py-16 bg-gray-50">
              <div className="max-w-7xl mx-auto px-4">
                <div className="flex items-center justify-between mb-8">
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
